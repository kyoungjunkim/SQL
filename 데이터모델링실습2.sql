...
insert into `departments` values ('110','비교기과','정약용','051-123-0110');
insert into `departments` values ('111','안과','박지원','051-123-0111');
insert into `departments` values ('112','치과','전봉준','051-123-0112');


insert into `Doctors` values ('D101101','김유신','1976-01-21','M','101','과장','010-1101-1976','kumys@bw.com');
...
insert into `patients` (`patId`,`docId`,`nurId`,`patName`,`patJumin`,`patGen`,`patAddr`,`patPhone`,`patJob`) values ('P102101','D102101','N102101','정우성','760121-1234567','M','서울','010-1101-7601','배우');
insert into `patients` (`patId`,`docId`,`nurId`,`patName`,`patJumin`,`patGen`,`patAddr`,`patPhone`,`patJob`) values ('P103101','D103101','N103101','이정재','750611-1234567','M','서울','010-1102-7506','배우');
...
insert into `patients` (`patId`,`docId`,`nurId`,`patName`,`patJumin`,`patGen`,`patAddr`,`patPhone`,`patJob`) values ('P102103','D102104','N102102','유재석','721128-1234567','M','부산','010-6101-7211','개그맨');
insert into `patients` (`patId`,`docId`,`nurId`,`patName`,`patJumin`,`patGen`,`patAddr`,`patPhone`,`patJob`) values ('P107101','D107104','N107101','강호동','920907-1234567','M','부산','010-7103-9209','개그맨');
insert into `patients` values ('P105102','D105101','N105101','조인성','891209-1234567','M','광주','010-7104-8912','join@gmail.com','배우');
insert into `patients` values ('P104103','D104101','N104101','강동원','770314-1234567','M','광주','010-8101-7703','dong@gmail.com','배우');
